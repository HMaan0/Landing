...
const DeploymentWorkFlow = () => {
  ...
  const buttonsLeft = [
    ...
    { title: "Generated a live link", delay: 13 },
    {
      title: (
        <>
          Live link{" "}
  ...
  const buttonsRight = [
    { title: "Data Ingestion", delay: 2 },
    { title: "Cleaning", delay: 3 },
    { title: "Transformation", delay: 4 },
    { title: "Model Training", delay: 10 },
  ];
